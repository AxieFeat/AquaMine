...
class AquaRegistryReference<T, V : T>(private val registry: Registry<T>, override val key: ResourceKey<V>) : RegistryReference<V> {
    ...
    object Factory : RegistryReference.Factory {
        ...
        override fun <T, V : T> of(registry: Registry<T>, key: Key): RegistryReference<V> {
            return AquaRegistryReference(registry, AquaResourceKey.of(registry.key.location, key))
        }
    }
}
