...
@JvmRecord
data class PacketInClickContainerButton(val containerId: Byte, val buttonId: Byte) : InboundPacket<PlayPacketHandler> {

    constructor(reader: BinaryReader) : this(reader.readByte(), reader.readByte())
