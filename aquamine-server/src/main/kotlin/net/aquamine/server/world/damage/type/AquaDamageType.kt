...
data class AquaDamageType(
    ...
    class Builder(private var key: Key, private var translationKey: String) {
        ...
        fun build(): AquaDamageType {
            return AquaDamageType(key, translationKey, damagesHelmet, bypassesArmor, bypassesInvulnerability, bypassesMagic, exhaustion, fire,
