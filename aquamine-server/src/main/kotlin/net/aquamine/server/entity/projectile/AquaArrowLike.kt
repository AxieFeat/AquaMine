...
abstract class AquaArrowLike(world: AquaWorld) : AquaProjectile(world), ArrowLike {

    override val serializer: EntitySerializer<out AquaArrowLike>
    ...
    var internalStuckInBlock: AquaBlockState? = null
