...
object CatSerializer : EntitySerializer<AquaCat> {

    private const val TYPE_TAG = "CatType"
    private const val COLLAR_COLOR_TAG = "CollarColor"

    override fun load(entity: AquaCat, data: CompoundTag) {
    ...
    override fun save(entity: AquaCat): CompoundTag.Builder = TamableSerializer.save(entity).apply {
