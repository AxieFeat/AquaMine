...
open class AquaBoat(world: AquaWorld) : AquaEntity(world), Boat {

    override val type: AquaEntityType<AquaBoat>
        get() = AquaEntityTypes.BOAT
    override val serializer: EntitySerializer<out AquaBoat>
        get() = BoatSerializer
