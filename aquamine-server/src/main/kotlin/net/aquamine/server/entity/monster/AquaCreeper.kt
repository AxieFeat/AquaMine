...
class AquaCreeper(world: AquaWorld) : AquaMonster(world), Creeper {

    override val type: AquaEntityType<AquaCreeper>
        get() = AquaEntityTypes.CREEPER
    override val serializer: EntitySerializer<AquaCreeper>
    ...
    companion object {
        ...
        @JvmStatic
        fun attributes(): AttributeSupplier.Builder = AquaMonster.attributes().add(AquaAttributeTypes.MOVEMENT_SPEED, DEFAULT_MOVEMENT_SPEED)
    }
}
