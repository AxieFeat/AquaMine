...
object TurtleSerializer : EntitySerializer<AquaTurtle> {
    ...
    override fun save(entity: AquaTurtle): CompoundTag.Builder = AgeableSerializer.save(entity).apply {
