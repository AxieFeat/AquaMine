...
object ZombieSerializer : EntitySerializer<AquaZombie> {

    private const val BABY_TAG = "IsBaby"
    private const val CONVERSION_TIME_TAG = "DrownedConversionTime"

    override fun load(entity: AquaZombie, data: CompoundTag) {
    ...
    override fun save(entity: AquaZombie): CompoundTag.Builder = MobSerializer.save(entity).apply {
