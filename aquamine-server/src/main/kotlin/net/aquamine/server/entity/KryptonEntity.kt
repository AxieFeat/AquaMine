...
import net.aquamine.server.event.player.KryptonEntityEnterViewEvent
import net.aquamine.server.event.player.KryptonEntityExitViewEvent
...
abstract class KryptonEntity(final override var world: KryptonWorld) : BaseEntity, SerializableEntity, AquaSender, Tickable {
