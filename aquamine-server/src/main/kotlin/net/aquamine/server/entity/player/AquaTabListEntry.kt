...
class AquaTabListEntry(
    override val tabList: AquaTabList,
    ...
    override fun equals(other: Any?): Boolean {
        return this === other || other is AquaTabListEntry && uuid == other.uuid
    }

    override fun hashCode(): Int = uuid.hashCode()

    override fun toString(): String = "AquaTabListEntry(uuid=$uuid, profile=$profile, displayName=$displayName, gameMode=$gameMode, " +
            "latency=$latency, listed=$listed)"

    class Builder(private val tabList: AquaTabList, private val uuid: UUID, private val profile: GameProfile) : TabListEntry.Builder {
        ...
        override fun buildAndRegister(): TabListEntry {
            val entry = AquaTabListEntry(tabList, uuid, profile, displayName, gameMode, latency, listed)
