...
object DolphinSerializer : EntitySerializer<AquaDolphin> {
    ...
    override fun load(entity: AquaDolphin, data: CompoundTag) {
    ...
    override fun save(entity: AquaDolphin): CompoundTag.Builder = MobSerializer.save(entity).apply {
