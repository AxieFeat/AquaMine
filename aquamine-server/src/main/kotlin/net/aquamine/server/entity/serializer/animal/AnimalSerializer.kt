...
import net.aquamine.server.entity.animal.AquaAnimal
...
object AnimalSerializer : EntitySerializer<AquaAnimal> {

    private const val LOVE_TAG = "InLove"
    private const val LOVE_CAUSE_TAG = "LoveCause"

    override fun load(entity: AquaAnimal, data: CompoundTag) {
    ...
    override fun save(entity: AquaAnimal): CompoundTag.Builder = AgeableSerializer.save(entity).apply {
