...
import net.aquamine.server.entity.AquaAreaEffectCloud
import xyz.axie.nbt.CompoundTag

object AreaEffectCloudSerializer : EntitySerializer<AquaAreaEffectCloud> {
    ...
    override fun load(entity: AquaAreaEffectCloud, data: CompoundTag) {
    ...
    override fun save(entity: AquaAreaEffectCloud): CompoundTag.Builder = BaseEntitySerializer.save(entity).apply {
