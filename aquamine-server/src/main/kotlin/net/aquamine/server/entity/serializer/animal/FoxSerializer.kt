...
object FoxSerializer : EntitySerializer<AquaFox> {
    ...
    override fun save(entity: AquaFox): CompoundTag.Builder = AgeableSerializer.save(entity).apply {
        list(TRUSTED_TAG) {
    ...
    @JvmStatic
    private fun addTrustedId(entity: AquaFox, uuid: UUID?) {
