...
import net.aquamine.server.effect.particle.builder.KryptonSimpleParticleEffectBuilder
...
data class AquaSimpleParticleType(private val key: Key) : SimpleParticleType {
    ...
    override fun builder(): SimpleParticleEffectBuilder = KryptonSimpleParticleEffectBuilder(this)
}
