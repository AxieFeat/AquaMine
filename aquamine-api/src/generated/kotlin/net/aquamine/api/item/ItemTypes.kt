...
public object ItemTypes {
    ...
    @JvmField
    public val BAMBOO_PLANKS: RegistryReference<ItemType> = of("bamboo_planks")
    @JvmField
    ...
    @JvmField
    public val BAMBOO_MOSAIC: RegistryReference<ItemType> = of("bamboo_mosaic")
    @JvmField
    ...
    @JvmField
    public val BAMBOO_BLOCK: RegistryReference<ItemType> = of("bamboo_block")
    @JvmField
    ...
    @JvmField
    public val STRIPPED_BAMBOO_BLOCK: RegistryReference<ItemType> = of("stripped_bamboo_block")
    @JvmField
    ...
    @JvmField
    public val BAMBOO_SLAB: RegistryReference<ItemType> = of("bamboo_slab")
    @JvmField
    public val BAMBOO_MOSAIC_SLAB: RegistryReference<ItemType> = of("bamboo_mosaic_slab")
    @JvmField
    ...
    @JvmField
    public val CHISELED_BOOKSHELF: RegistryReference<ItemType> = of("chiseled_bookshelf")
    @JvmField
    ...
    @JvmField
    public val BAMBOO_FENCE: RegistryReference<ItemType> = of("bamboo_fence")
    @JvmField
    ...
    @JvmField
    public val BAMBOO_STAIRS: RegistryReference<ItemType> = of("bamboo_stairs")
    @JvmField
    public val BAMBOO_MOSAIC_STAIRS: RegistryReference<ItemType> = of("bamboo_mosaic_stairs")
    @JvmField
    ...
    @JvmField
    public val BAMBOO_BUTTON: RegistryReference<ItemType> = of("bamboo_button")
    @JvmField
    ...
    @JvmField
    public val BAMBOO_PRESSURE_PLATE: RegistryReference<ItemType> = of("bamboo_pressure_plate")
    @JvmField
    ...
    @JvmField
    public val BAMBOO_DOOR: RegistryReference<ItemType> = of("bamboo_door")
    @JvmField
    ...
    @JvmField
    public val BAMBOO_TRAPDOOR: RegistryReference<ItemType> = of("bamboo_trapdoor")
    @JvmField
    ...
    @JvmField
    public val BAMBOO_FENCE_GATE: RegistryReference<ItemType> = of("bamboo_fence_gate")
    @JvmField
    ...
    @JvmField
    public val BAMBOO_RAFT: RegistryReference<ItemType> = of("bamboo_raft")
    @JvmField
    public val BAMBOO_CHEST_RAFT: RegistryReference<ItemType> = of("bamboo_chest_raft")
    @JvmField
    ...
    @JvmField
    public val BAMBOO_SIGN: RegistryReference<ItemType> = of("bamboo_sign")
    @JvmField
    ...
    @JvmField
    public val OAK_HANGING_SIGN: RegistryReference<ItemType> = of("oak_hanging_sign")
    @JvmField
    public val SPRUCE_HANGING_SIGN: RegistryReference<ItemType> = of("spruce_hanging_sign")
    @JvmField
    public val BIRCH_HANGING_SIGN: RegistryReference<ItemType> = of("birch_hanging_sign")
    @JvmField
    public val JUNGLE_HANGING_SIGN: RegistryReference<ItemType> = of("jungle_hanging_sign")
    @JvmField
    public val ACACIA_HANGING_SIGN: RegistryReference<ItemType> = of("acacia_hanging_sign")
    @JvmField
    public val DARK_OAK_HANGING_SIGN: RegistryReference<ItemType> = of("dark_oak_hanging_sign")
    @JvmField
    public val MANGROVE_HANGING_SIGN: RegistryReference<ItemType> = of("mangrove_hanging_sign")
    @JvmField
    public val BAMBOO_HANGING_SIGN: RegistryReference<ItemType> = of("bamboo_hanging_sign")
    @JvmField
    public val CRIMSON_HANGING_SIGN: RegistryReference<ItemType> = of("crimson_hanging_sign")
    @JvmField
    public val WARPED_HANGING_SIGN: RegistryReference<ItemType> = of("warped_hanging_sign")
    @JvmField
    ...
    @JvmField
    public val CAMEL_SPAWN_EGG: RegistryReference<ItemType> = of("camel_spawn_egg")
    @JvmField
    ...
    @JvmField
    public val ENDER_DRAGON_SPAWN_EGG: RegistryReference<ItemType> = of("ender_dragon_spawn_egg")
    @JvmField
    ...
    @JvmField
    public val IRON_GOLEM_SPAWN_EGG: RegistryReference<ItemType> = of("iron_golem_spawn_egg")
    @JvmField
    ...
    @JvmField
    public val SNOW_GOLEM_SPAWN_EGG: RegistryReference<ItemType> = of("snow_golem_spawn_egg")
    @JvmField
    ...
    @JvmField
    public val WITHER_SPAWN_EGG: RegistryReference<ItemType> = of("wither_spawn_egg")
    @JvmField
    ...
    @JvmField
    public val PIGLIN_HEAD: RegistryReference<ItemType> = of("piglin_head")
    @JvmField
