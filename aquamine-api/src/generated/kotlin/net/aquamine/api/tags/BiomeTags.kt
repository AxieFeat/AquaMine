...
public object BiomeTags {
    ...
    @JvmField
    public val HAS_RUINED_PORTAL_MOUNTAIN: TagKey<Biome> =
            get("has_structure/ruined_portal_mountain")

    @JvmField
    public val HAS_RUINED_PORTAL_STANDARD: TagKey<Biome> =
    ...
    @JvmField
    public val REQUIRED_OCEAN_MONUMENT_SURROUNDING: TagKey<Biome> =
    ...
    @JvmField
    public val WITHOUT_WANDERING_TRADER_SPAWNS: TagKey<Biome> =
    ...
    @JvmField
    public val ONLY_ALLOWS_SNOW_AND_GOLD_RABBITS: TagKey<Biome> =
    ...
    @JvmField
    public val ALLOWS_TROPICAL_FISH_SPAWNS_AT_ANY_HEIGHT: TagKey<Biome> =
            get("allows_tropical_fish_spawns_at_any_height")

    @JvmField
    public val POLAR_BEARS_SPAWN_ON_ALTERNATE_BLOCKS: TagKey<Biome> =
