...
public object BlockTags {
    ...
    @JvmField
    public val BAMBOO_BLOCKS: TagKey<Block> = get("bamboo_blocks")
    ...
    @JvmField
    public val CEILING_HANGING_SIGNS: TagKey<Block> = get("ceiling_hanging_signs")

    @JvmField
    public val WALL_HANGING_SIGNS: TagKey<Block> = get("wall_hanging_signs")

    @JvmField
    public val ALL_HANGING_SIGNS: TagKey<Block> = get("all_hanging_signs")

    @JvmField
    public val ALL_SIGNS: TagKey<Block> = get("all_signs")
    ...
    @JvmField
    public val POLAR_BEARS_SPAWNABLE_ON_ALTERNATE: TagKey<Block> =
    ...
    @JvmField
    public val MANGROVE_ROOTS_CAN_GROW_THROUGH: TagKey<Block> =
    ...
    @JvmField
    public val INVALID_SPAWN_INSIDE: TagKey<Block> = get("invalid_spawn_inside")
