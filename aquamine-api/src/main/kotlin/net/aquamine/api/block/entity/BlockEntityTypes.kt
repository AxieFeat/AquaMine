...
object BlockEntityTypes {
    ...
    @JvmField
    val MOB_SPAWNER: RegistryReference<BlockEntityType<MobSpawner>> = of("mob_spawner")
    @JvmField
    val PISTON: RegistryReference<BlockEntityType<MovingPiston>> = of("piston")
    @JvmField
    val BREWING_STAND: RegistryReference<BlockEntityType<BrewingStand>> = of("brewing_stand")
    @JvmField
    val ENCHANTING_TABLE: RegistryReference<BlockEntityType<EnchantmentTable>> = of("enchanting_table")
    @JvmField
    val END_PORTAL: RegistryReference<BlockEntityType<EndPortal>> = of("end_portal")
    @JvmField
    val BEACON: RegistryReference<BlockEntityType<Beacon>> = of("beacon")
    @JvmField
    val SKULL: RegistryReference<BlockEntityType<Skull>> = of("skull")
    @JvmField
    val DAYLIGHT_DETECTOR: RegistryReference<BlockEntityType<DaylightDetector>> = of("daylight_detector")
    @JvmField
    ...
    @JvmField
    val STRUCTURE_BLOCK: RegistryReference<BlockEntityType<StructureBlock>> = of("structure_block")
    @JvmField
    val END_GATEWAY: RegistryReference<BlockEntityType<EndGateway>> = of("end_gateway")
    @JvmField
    val COMMAND_BLOCK: RegistryReference<BlockEntityType<CommandBlock>> = of("command_block")
    @JvmField
    ...
    @JvmField
    val SCULK_CATALYST: RegistryReference<BlockEntityType<SculkCatalyst>> = of("sculk_catalyst")
    @JvmField
    val SCULK_SHRIEKER: RegistryReference<BlockEntityType<SculkShrieker>> = of("sculk_shrieker")
