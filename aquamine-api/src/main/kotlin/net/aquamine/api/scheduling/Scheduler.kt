...
/**
 * A scheduler that will execute tasks with precision dependent on the tick
 * rate of the server.
 *
...
interface Scheduler {
     ...
     * execution of a task. It is recommended that, if you wish to specify
     ...
     * @param period The delay between later executions.
     * @param executionType The execution type of the task.
     *
     * @return The scheduled task.
     */
