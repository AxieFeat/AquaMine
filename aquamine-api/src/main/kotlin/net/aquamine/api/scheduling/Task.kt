 ...
 * * Canceled: The task is not available for scheduling and cannot be made
 * available.
 */
interface Task {
    ...
    /**
     * Checks if this task is alive, meaning it is not canceled and is
     ...
     * rescheduled. It may finish its execution; however, this behavior is
     ...
     * It is designed to be straightforward and easy to use, at the cost of flexibility.
     *
    ...
    interface Builder {
        ...
        /**
         * Sets the delay between later executions of the task.
         *
         * This defines how long after each execution the task will be run
         * again.
         *
         ...
         * Sets the delay between later executions of the task.
         *
         * @param duration The duration of the delay between executions.
         *
         * @return This builder.
         *
         * @see period
