...
data class Position(
    ...
    fun add(x: Double, y: Double, z: Double): Position =
        Position(this.x + x, this.y + y, this.z + z, this.yaw, this.pitch)
     ...
     * @return The resulting position.
     */
    fun multiply(x: Double, y: Double, z: Double): Position =
        Position(this.x * x, this.y * y, this.z * z, this.yaw, this.pitch)
     ...
     */
    fun divide(x: Double, y: Double, z: Double): Position =
        Position(this.x / x, this.y / y, this.z / z, this.yaw, this.pitch)
     ...
     * @return The squared distance.
     */
    fun distanceSquared(other: Vec3i): Double =
        distanceSquared(other.x.toDouble(), other.y.toDouble(), other.z.toDouble())
