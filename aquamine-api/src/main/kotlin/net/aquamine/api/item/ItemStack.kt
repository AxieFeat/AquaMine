...
import net.aquamine.annotations.dsl.ItemDsl
...
interface ItemStack : Buildable<ItemStack, ItemStack.Builder>, HoverEventSource<HoverEvent.ShowItem> {
    ...
    companion object {
        ...
        @JvmStatic
        @Contract("_ -> new", pure = true)
        fun of(type: ItemType): ItemStack = AquaMine.factory<Factory>().builder().type(type).build()
        ...
        @JvmStatic
        @Contract("_, _ -> new", pure = true)
        fun of(type: ItemType, amount: Int): ItemStack = AquaMine.factory<Factory>().builder().type(type).amount(amount).build()
        ...
        @JvmStatic
        @Contract(pure = true)
        fun empty(): ItemStack = AquaMine.factory<Factory>().empty()
    }
}
